...
# MinerU Online API Configuration
MINERU_ONLINE_ENV_KEYS = [
    "MINERU_ONLINE_ENABLED",
    "MINERU_ONLINE_TOKEN",
    "MINERU_ONLINE_MODEL_VERSION",
    "MINERU_ONLINE_POLL_INTERVAL",
    "MINERU_ONLINE_POLL_TIMEOUT",
    "MINERU_ONLINE_TEMP_DIR",
]
MINERU_ONLINE_DEFAULT_CONFIG = {
    "MINERU_ONLINE_ENABLED": False,
    "MINERU_ONLINE_TOKEN": "",
    "MINERU_ONLINE_MODEL_VERSION": "vlm",
    "MINERU_ONLINE_POLL_INTERVAL": 5,
    "MINERU_ONLINE_POLL_TIMEOUT": 300,
    "MINERU_ONLINE_TEMP_DIR": "",
}
